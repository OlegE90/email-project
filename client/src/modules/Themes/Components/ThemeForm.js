...
export class ThemeFormComponent extends React.Component {
    ...
    componentWillReceiveProps({match: {params}}){
        ...
        params.id && (!item.data || item.data._id !== params.id) && fetchThemeItem(params.id);
            ...
            <form>
                ...
                <div className="row">
                    <div className="input-field col s12">
                        <input placeholder="Name theme" name="title" value={title} onChange={this.handlerTitleChange}
